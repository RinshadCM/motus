    ...
    return (
        <React.Fragment>
                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        <div className="file-manager-sidebar border">
                            <div className="p-4 d-flex flex-column h-100">
                                <div className="mb-3">
                                    <button className="btn btn-primary w-100" onClick={() => setModalProject(true)}><i className="ri-add-line align-bottom"></i> Add Project</button>
                                </div>
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0 border">
                            ...
                            <div className="todo-content position-relative px-4 mx-n4" id="todo-content">
                                ...
                                <div className="py-4 mt-4 text-center" id="noresult" style={{ display: "none" }}>
                                    <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#122044,secondary:#4788ff" style={{ width: "72px", height: "72px" }}></lord-icon>
            ...
            <Modal id="createTask" isOpen={modalTodo} toggle={toggle} modalClassName="zoomIn" centered tabIndex="-1">
                <ModalHeader toggle={toggle} className="p-3 bg-soft-primary"> {!!isEdit ? "Edit Task" : "Create Task"} </ModalHeader>
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-danger" onClick={() => setModalTodo(false)}><i className="ri-close-fill align-bottom"></i> Close</button>
                ...
                <ModalBody>
                    <Form onSubmit={(e) => {
                        ...
                        <div className="mb-4">
                            ...
                            <Input type="text" className="form-control" id="projectname-input" placeholder="Enter project name"
                                name='title'
                                validate={{
                                    required: { value: true },
                                }}
