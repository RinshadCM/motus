                                              ...
                                              >
                                                <div className="accordion-body ms-2 ps-5 pt-0">
                                                  <h6 className="mb-1">
                                                    ...
                                                    corrupti eius facilis sit
                                                    voluptatum est quia
                                                    praesentium
                                                  </h6>
                                                  <p className="text-muted">
                                                    Created by:Rde Admin 2021 -
                                                    05:34PM <br />@ Wed, 15 Dec
                                                  </p>
                                                </div>
                                              </Collapse>
                                            </div>
                                              ...
                                              >
                                                <div className="accordion-body ms-2 ps-5 pt-0">
                                                  <h6 className="fs-14">
                                                    Lorem, ipsum dolor sit amet
                                                    consectetur adipisicing
                                                    elit. Itaque facere rem quia
                                                    eveniet maxime ipsum quam
                                                    earum minus,{" "}
                                                  </h6>
                                                  <p className="text-muted mb-0">
                                                    Created by:Rde Admin 05:34PM{" "}
                                                    <br /> @ Wed, 15 Dec 2021{" "}
                                                  </p>
                                                </div>
                                              </Collapse>
