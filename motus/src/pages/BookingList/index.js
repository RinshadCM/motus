...
const BookingList = () => {
        ...
        Cell: (order) => (
          <>
            ...
            <span className="badge badge-soft-primary">
              {handleValidTime(order.row.original.orderDate)} to 8:00 PM
            </span>
          </>
        ),
      },
      {
        Header: "Pickup and Drop Location",
        accessor: "customer",
        filterable: false,
        Cell: () => (
          <>
            <a className="text-primary">Airport Terminal 3</a>
            <br />
            Hotel Hilton Garden
          </>
        ),
      ...
      },
      {
        ...
        Cell: () => (
          <>
            Nissan Patrol
            <br />
            <span className="badge badge-outline-dark">DSR 6653</span>
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        Cell: (cell) => {
          switch (cell.value) {
            case "Inprogress":
              return (
                <span className="badge text-bg-info">Driver at pickup point</span>
              );
            case "Delivered":
              return <span className="badge text-bg-success">Passenger onboarded</span>;
          ...
          return (
            <ul className="list-inline hstack gap-2 mb-0">
              <li className="list-inline-item">
                ...
                >
                  <i className="ri-map-pin-fill fs-16"></i>
                </Link>
              </li>
  ...
  return (
    <div className="page-content">
      ...
      />
      <Container fluid>
        <BreadCrumb title="All Bookings List" pageTitle="Events and Bookings" />
        <Row>
          <Col lg={12}>
            <Card id="orderList">
              <CardHeader className="card-header border-0">
                <Row className="align-items-center gy-3">
                  <div className="col-sm">
                    <h5 className="card-title mb-0">Saudi Arabian Grandprix</h5>
                  </div>
                ...
                <div>
                  ...
                  >
                    <NavItem>
                      <NavLink
                        ...
                        href="#"
                      >
                        <i className="ri-ticket-2-line me-1 align-bottom"></i>{" "}
                        All Bookings
                    ...
                    <NavItem>
                      <NavLink
                        ...
                        href="#"
                      >
                        <i className="ri-flight-land-line me-1 align-bottom"></i>{" "}
                        Arrivals
                      </NavLink>
                    </NavItem>
                    <NavItem>
                      <NavLink
                        ...
                        href="#"
                      >
                        <i className="ri-flight-takeoff-line me-1 align-bottom"></i>{" "}
                        Departures{" "}
                      </NavLink>
                    </NavItem>
                    <NavItem>
                      <NavLink
                        ...
                        href="#"
                      >
                        <i className="ri-timer-line me-1 align-bottom"></i>{" "}
                        Hourly Hires{" "}
                      </NavLink>
                    </NavItem>
                    <NavItem>
                      <NavLink
                        ...
                        href="#"
                      >
                        <i className="ri-arrow-left-right-line me-1 align-bottom"></i>{" "}
                        Shuttle Services
                      </NavLink>
                    </NavItem>
                    <NavItem>
                  ...
                  {isOrderSuccess && orderList.length ? (
                    <TableContainer
                      ...
                      isOrderFilter={true}
                      SearchPlaceholder="Search for booking ID, vehicle, trip status or something..."
                    />
                  ) : (
                    <Loader error={error} />
                  )}
