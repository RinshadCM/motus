                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Sign in to continue to MOTUS | ONE.</p>
                                                </div>
                                                ...
                                                <div className="mt-4">
                                                    <form action="/">
                                                        ...
                                                        <div className="mt-4">
                                                            <Button color="primary" className="w-100" type="submit">Sign In</Button>
                                                        </div>
                                                    </form>
                                                </div>

                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">If you forgot your password you can <a href="" className="fw-semibold text-primary text-decoration-underline">Reset it</a> </p>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
